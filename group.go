...
// newRouteGroup creates a new RouteGroup with the given path prefix, macross, and handlers.
func newRouteGroup(prefix string, macross *Macross, handlers []Handler) *RouteGroup {
	return &RouteGroup{
		prefix:   prefix,
		macross:  macross,
		handlers: handlers,
...
// To adds a route to the macross with the given HTTP methods, route path, and handlers.
...
func (r *RouteGroup) Group(prefix string, handlers ...Handler) *RouteGroup {
	...
	return newRouteGroup(r.prefix+prefix, r.macross, r.handlers)
}
